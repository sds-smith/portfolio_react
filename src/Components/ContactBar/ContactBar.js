...
function ContactBar(props) {
    ...
    return (
        <div className='contact-info' id='contact'>
            ...
            <h5><a className='contact-link'href='https://www.linkedin.com/in/shawn-smith-3379ab13/' target='_blank'  rel="noreferrer" onClick={toggleContact}>linkedin.com/shawn-smith</a></h5>
            <h5><a className='contact-link'href='https://github.com/sds-smith' target='_blank' rel="noreferrer" onClick={toggleContact}>github.com/sds-smith</a></h5>
